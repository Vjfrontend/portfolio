...
import TestimonialsImage02 from "@/public/images/WhatsApp Image 2024-08-22 at 13.27.09_62484467.jpg";
import TestimonialsImage01 from "@/public/images/CYF_4116.jpg";
import TestimonialsImage03 from "@/public/images/FB_IMG_17243311932120629.jpg";
// Import Swiper
...
export default function Testimonials() {
  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-9">
        <div className="pb-8">
                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">
                        victor consistently delivers high-quality work on time.
                        Their technical expertise and attention to detail are
                        unmatched.!
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">
                        victor is an exceptional developer who quickly turns
                        ideas into functional, polished applications. Highly
                        recommended!
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">
                        victor
                        consistently exceeds expectations with their innovative
                        solutions and timely delivery. A true asset to any
                        project.
                      </h4>
                    </div>
                  </div>
